...
class TenderService {
  ...
  mapFrontendToDatabaseFields(tenderData) {
    ...
    if (tenderData.specification_documents && Array.isArray(tenderData.specification_documents)) {
      ...
      mapped.attachments = [...mapped.attachments, ...tenderData.specification_documents];
    }
  ...
  async createTender(tenderData, userId) {
    ...
    try {
      ...
      await AuditLogService.log(
        ...
        null,
        'create',
        `Failed to create tender: ${error.message}`
      );
  ...
  async getTenderById(tenderId) {
    ...
    try {
      ...
      await AuditLogService.log(
        ...
        tenderId,
        'read',
        `Failed to get tender by ID: ${error.message}`
      );
  ...
  async updateTender(tenderId, updateData, userId) {
    ...
    try {
      ...
      await AuditLogService.log(
        ...
        tenderId,
        'update',
        `Failed to update tender: ${error.message}`
      );
  ...
  async deleteTender(tenderId, userId) {
    ...
    try {
      ...
      await AuditLogService.log(
        ...
        tenderId,
        'delete',
        `Failed to delete tender: ${error.message}`
      );
  ...
  async publishTender(tenderId, userId) {
    ...
    try {
      ...
      await AuditLogService.log(
        ...
        tenderId,
        'publish',
        `Failed to publish tender: ${error.message}`
      );
  ...
  async closeTender(tenderId, userId) {
    ...
    try {
      ...
      await AuditLogService.log(
        ...
        tenderId,
        'close',
        `Failed to close tender: ${error.message}`
      );
