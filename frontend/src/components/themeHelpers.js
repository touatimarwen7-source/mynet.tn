...
export const colors = {
  // Primary & Secondary
  primary: institutionalTheme.palette.primary.main, // #0056B3
  secondary: institutionalTheme.palette.secondary.main,

  // Neutrals
  background: institutionalTheme.palette.background.default, // #F9F9F9
  text: institutionalTheme.palette.text.primary, // #212121
  textSecondary: institutionalTheme.palette.text.secondary, // #666666
  ...
  // Borders & Dividers
  border: institutionalTheme.palette.divider, // #E0E0E0
  border_light: '#f0f0f0',
  border_dark: '#999999',
