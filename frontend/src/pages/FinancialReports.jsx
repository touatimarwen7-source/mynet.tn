            ...
            <Paper sx={{ border: '1px solid #E0E0E0', overflow: 'hidden' }}>
              <Table>
                <TableHead sx={{ backgroundColor: '#F5F5F5' }}>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 600, color: institutionalTheme.palette.primary.main }}>Nom du rapport</TableCell>
                    <TableCell sx={{ fontWeight: 600, color: institutionalTheme.palette.primary.main }}>Date</TableCell>
                    <TableCell sx={{ fontWeight: 600, color: institutionalTheme.palette.primary.main }}>Format</TableCell>
                    <TableCell sx={{ fontWeight: 600, color: institutionalTheme.palette.primary.main }} align="center">Télécharger</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {reports.map((r, idx) => (
                    <TableRow key={idx}>
                      ...
                      <TableCell align="center">
                        <Button size="small" startIcon={<DownloadIcon />} sx={{ color: institutionalTheme.palette.primary.main }}>Télécharger</Button>
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
